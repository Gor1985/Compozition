...
import com.android.compozition.Data.GameRepositoryImpl
...
import com.android.compozition.Domain.useCase.GenerationQuestionUseCase
import com.android.compozition.Domain.useCase.GetGameSettingsUseCase
...
class GameViewModel(
   ...
   private val application: Application, private val level: Level) : ViewModel() {
    ...
    private val generateQuestionUseCase = GenerationQuestionUseCase(repository)
...
init {
   ...
   private fun startGame() {
    ...
    private fun updateProgress() {
        ...
        _enoughPercent.value = percent >= gameSettings.minProcentOfRightAnswers
    }
    ...
    private fun getGameSettings() {
        ...
        _minPercent.value = gameSettings.minProcentOfRightAnswers
    }

    private fun startTimer() {
        timer = object : CountDownTimer(
            gameSettings.gameTameInSeconds * MILLIS_IN_SECONDS,
            MILLIS_IN_SECONDS
        ) {
